...
library CountdownRenderer {
    ...
    function render(RenderTypes.RenderCtx memory ctx) internal pure returns (string memory) {
        ...
        // Display block count (static digits)
        string memory rows = string(abi.encodePacked(
            _digitRow(80, ctx.blocksDisplay, digitCol, opacity, 100000000000, 10000000000, 1000000000, 100000000),
            _digitRow(140, ctx.blocksDisplay, digitCol, opacity, 10000000, 1000000, 100000, 10000),
            _digitRow(200, ctx.blocksDisplay, digitCol, opacity, 1000, 100, 10, 1)
        ));
